...
# Form implementation generated from reading ui file 'D:\Dev\mtgdeckconstructor\src\MTG_GUI\mtg_ui.ui'
#
...
class Ui_MTG_UI(object):
    def setupUi(self, MTG_UI):
        ...
        self.zoneComboBox = QtWidgets.QComboBox(self.decksTab)
        self.zoneComboBox.setObjectName("zoneComboBox")
        self.decksControlLayout.addWidget(self.zoneComboBox)
        self.decksCardImageFrame = QtWidgets.QFrame(self.decksTab)
        self.decksCardImageFrame.setMinimumSize(QtCore.QSize(0, 400))
